# Seamlessly Join a Linux EC2 Instance to Your AWS Managed Microsoft AD Directory<a name="seamlessly_join_linux_instance"></a>
...
+ Red Hat Enterprise 7 & Red Hat Enterprise Linux 8 \(HVM\) \(64\-bit x86\)
